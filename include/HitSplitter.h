 ...
 * @version $Id: HitSplitter.h,v 0.1 2020-09-27 11:24:21 fmeloni Exp $ 
 */

class HitSplitter : public Processor
{

public:
  virtual Processor *newProcessor() { return new HitSplitter; }
